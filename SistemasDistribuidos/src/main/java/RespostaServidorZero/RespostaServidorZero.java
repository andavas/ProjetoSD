 ...
 * @author Usuario
 */
public class RespostaServidorZero extends javax.swing.JFrame {

    /**
     * Creates new form Cliente
     */
    public RespostaServidorZero() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RespostaServidorZero.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RespostaServidorZero().setVisible(true);
            }
        });
    }
